...
<head>
  ...
  <link rel="stylesheet" href="first/assests/css/tailwind.min.css"/>
  <link rel="stylesheet" href="first/assests/css/style.css"/>

  <title>Language Translator</title>

  <!-- This is code from Tailblocks known as Contact us that we will change to make our format-->
  <body class="bg-gray-900">
    <!-- this for match vin css -->
        ...
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
          <div class="flex flex-wrap -m-2">
            ...
            <div class="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
              <!--Some business contact info that we can remove or change later-->
    ...
    <!--Javascrit that we'll use to help translate-->
